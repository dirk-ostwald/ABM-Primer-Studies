...
patch contrast discrimination task experimental or simulated data
...
P.sigma     = 0.2                                                               # observation standard deviation                                   
...
ax[1].plot(         sta.a_psy_x, 
                    sta.a_psy_mean, 
                    ls           = '-', 
                    color        =  blue[1], 
                    label        = 'Group mean')
ax[1].fill_between( sta.a_psy_x, 
...
ax[1].set_title('Psychometric function', fontsize = 22)
ax[1].set_xlabel('Normalized contrast difference', fontsize = 18)
