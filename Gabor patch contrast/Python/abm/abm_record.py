...
class abm_record:
    ...
    def __init__(self, P):
        ...
        # record attributes
        # ---------------------------------------------------------------------
        if P.mode == "gen":                                                     # experimental or generative modes
            self.mode   = "gen"                                                 # mode 
    ...
    def rec(self, task, agent):
        ...
        """
        Depending on the mode, this function records task and agent states to 
        the record dataframe or evaluates the log likelihood function.
        ...
        if self.mode == "gen":                                                  # generative mode 
            ...
            self.llh = self.llh + np.log(agent.pa)                              # log likelihood update
